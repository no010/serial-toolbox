...
from src.core.log_rotator import LogConfig, RotatingLogWriter
...
from src.core.serial_manager import DataFormat, SerialConfig, SerialManager
...
class SerialToolboxMainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.setGeometry(
            ...
            self.app_config.window_w,
            self.app_config.window_h,
        )
    ...
    def connect_serial(self):
        ...
        config = SerialConfig(
            port=port, baudrate=baudrate, data_bits=databits, stop_bits=stopbits, parity=parity
        )
