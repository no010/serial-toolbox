...
class RegisterValue:
    ...
    float_value: Optional[float] = None  # IEEE754 浮点 (需要2个寄存器)
    timestamp: str = ""
...
class ModbusResponseParser:
    ...
    def __init__(self):
        ...
        self.last_request_func: Optional[int] = None
        self.last_request_addr: Optional[int] = None
        self.last_request_start: Optional[int] = None
        self.last_request_quantity: Optional[int] = None
    ...
    def _try_parse_frame(self) -> Optional[ModbusResponse]:
        """尝试从 buffer 解析一帧"""
