...
class MultiSerialManager:
    ...
    def __init__(self):
        ...
        self.on_data_received: Callable[[str, bytes], None] | None = None
        self.on_error: Callable[[str, str], None] | None = None
        self.on_connection_changed: Callable[[str, bool], None] | None = None
    ...
    def get_slot(self, name: str) -> PortSlot | None:
        """获取槽位"""
